                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#useradd-4" class="list-group-item list-group-item-action border-0"><?php echo e(__('Payment Setting')); ?>
                                ...
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#useradd-5" class="list-group-item list-group-item-action border-0"><?php echo e(__('Zoom-Meeting Setting')); ?>

                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#useradd-6" class="list-group-item list-group-item-action border-0"><?php echo e(__('Slack Setting')); ?>

                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#useradd-7" class="list-group-item list-group-item-action border-0"><?php echo e(__('Telegram Setting')); ?>

                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#useradd-8" class="list-group-item list-group-item-action border-0"><?php echo e(__('Twillio Setting')); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    <div class="custom-control custom-switch">
                                        <label class="text-dark mb-1 mt-1" for="SITE_RTL"><?php echo e(__('RTL')); ?></label>
                                        <div class="">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="form-label mb-0"><?php echo e(__('App Site URL')); ?></label> <br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/settings/company.blade.php ENDPATH**/ ?>