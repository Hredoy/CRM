...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="my-4 text-center"><?php echo e(__("Don't have an account?")); ?> <a href="<?php echo e(route('register','ar')); ?>" class="text-primary"><?php echo e(__('Register')); ?></a></p>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/auth/login.blade.php ENDPATH**/ ?>