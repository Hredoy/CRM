                    ...
                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                        ...
                        <h></h>
                            <?php if(\Auth::user()->type=='super admin'): ?>
                                <a class="drpdown-item text-primary" href="<?php echo e(route('manage.language',[isset($lang)?$lang:'en'])); ?>"><?php echo e(__('Manage Language ')); ?></a>
                            <?php endif; ?>
                    </div>
                </li>
            </ul>
...
<?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/partials/admin/header.blade.php ENDPATH**/ ?>