                ...
                <div class="card-body project_table">
                    <div class="table-responsive ">
                        <table class="table table-hover mb-0">
                            ...
                            <?php else: ?>
                                <div class="py-5">
                                    <h5 class="text-center mb-0"><?php echo e(__('No Due Projects Found.')); ?></h5>
                                </div>
                            <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>