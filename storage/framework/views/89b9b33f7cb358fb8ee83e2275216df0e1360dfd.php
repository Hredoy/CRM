                                ...
                                <div class="card-header-right">
                                    <div class="btn-group card-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="<?php echo e(route('clients.show',$client->id)); ?>"  class="dropdown-item" data-bs-original-title="<?php echo e(__('View')); ?>">
                                                <i class="ti ti-eye"></i>
                                                <span><?php echo e(__('Show')); ?></span>
                                            </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/clients/index.blade.php ENDPATH**/ ?>