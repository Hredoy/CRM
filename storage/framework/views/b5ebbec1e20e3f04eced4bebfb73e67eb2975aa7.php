                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show career')): ?>
                                                <li class="dash-item <?php echo e((request()->is('career*') ? 'active' : '')); ?>">
                                                    <a class="dash-link" href="<?php echo e(route('career',[\Auth::user()->creatorId(),'en'])); ?>"><?php echo e(__('Career')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    </li>
                        ...
                        <?php if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder')): ?>
                            <li class="dash-item dash-hasmenu
                                        <?php echo e((Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' ||
                                            ...
                                            Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response')?' active dash-trigger':''); ?>">
                        ...
                        <?php if( Gate::check('manage project')): ?>
                            <li class="dash-item dash-hasmenu
                                            <?php echo e(( Request::segment(1) == 'project' || Request::segment(1) == 'bugs-report' || Request::segment(1) == 'bugstatus' ||
                                                 ...
                                                 Request::segment(1) == 'project' || Request::segment(1) == 'projects') ? 'active dash-trigger' : ''); ?>">
                    ...
                    <?php if(Gate::check('manage system settings')): ?>
                        <li class="dash-item dash-hasmenu <?php echo e((Request::route()->getName() == 'systems.index') ? ' active' : ''); ?>">
                            <a href="<?php echo e(route('systems.index')); ?>" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-settings"></i></span><span class="dash-mtext"><?php echo e(__('System Setting')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>