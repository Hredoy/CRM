...
unset($__errorArgs, $__bag); ?> border-0" <?php if($document->is_required == 1 && empty($employeedoc[$document->id]) ): ?> required <?php endif; ?> name="document[<?php echo e($document->id); ?>]"  onchange="document.getElementById('<?php echo e('blah'.$key); ?>').src = window.URL.createObjectURL(this.files[0])" type="file"  data-filename="<?php echo e($document->id.'_filename'); ?>">
                                            ...
                                            <img id="<?php echo e('blah'.$key); ?>" src=""  width="25%" />
                                        </div>
        ...
        function getDepartment(branch_id)
        {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#department_id').empty();
                    $('#department_id').append('<option value="" disabled><?php echo e(__('Please Select')); ?></option>');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/employee/edit.blade.php ENDPATH**/ ?>