        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                        <p class="">
                            <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright ERP Ameltek')); ?> <?php echo e(date('Y')); ?>
...
<?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/layouts/auth.blade.php ENDPATH**/ ?>