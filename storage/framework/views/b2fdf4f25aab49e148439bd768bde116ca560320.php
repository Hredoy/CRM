                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3"><h3><?php echo e($user->total_orders); ?></h3></div>
                            <div class="ms-3 mb-3 mt-3">
                                <h6><?php echo e(__('Total Order Amount')); ?> : <span class="text-dark"><?php echo e(\Auth::user()->priceFormat($user['total_orders_price'])); ?></span></h6>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ameltek/public_html/subdomains/work.ameltek.com/resources/views/dashboard/super_admin.blade.php ENDPATH**/ ?>